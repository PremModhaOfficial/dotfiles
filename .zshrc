...
# color completion "{(s.:.)LL_COLORS}" means that we are using the colors from the list
zstyle ':completion:*' list-colors "${(s.:.)LS_COLORS}"

zstyle ':fzf-tab:complete:cd:*' fzf-preview 'eza -a --color-scale-mode gradient --color=always $realpath'
zstyle ':fzf-tab:complete:__zoxide_z:*' fzf-preview 'eza -a --color-scale-mode gradient --color=always $realpath'
...
# alias ls='ls --color' # my preferred listing
